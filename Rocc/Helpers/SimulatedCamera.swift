...
public final class DummyCamera: Camera {
    ...
    private func constructCurrentEvent() -> CameraEvent {
        ...
        return CameraEvent(
            ...
            liveViewInfo: nil,
            zoomPosition: nil,
            availableFunctions: [.setISO, .setShutterSpeed, .setAperture, .setExposureCompensation, .setSelfTimerDuration, .setWhiteBalance, .startZooming, .setExposureMode],
            supportedFunctions: [.setISO, .setShutterSpeed, .setAperture, .setExposureCompensation, .setSelfTimerDuration, .setWhiteBalance, .startZooming, .setExposureMode],
