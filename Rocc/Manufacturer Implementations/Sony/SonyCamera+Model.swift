    ...
    enum Model: String, CaseIterable {
        ...
        internal static func supporting(function: _CameraFunction) -> [Model] {
            ...
            case .setContinuousShootingSpeed, .getContinuousShootingSpeed:
                ...
                _supportingModels.append(contentsOf: cyberShotSeries)
                _supportingModels = _supportingModels.filter({ ![.a7, .a7r, .a7s, .a7iii, .a9ii, .a5000, .a5100, .a6000, .a6400, .a6600, .cyberShot_HX60, .cyberShot_HX60V, .cyberShot_HX400, .cyberShot_HX400V, .cyberShot_RX100M3].contains($0) })
