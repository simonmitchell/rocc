...
extension ShutterSpeed: PTPPropValueConvertable {
    ...
    init?(value: PTPDevicePropertyDataType, manufacturer: Manufacturer) {
        ...
        case .canon:
            ...
            default:
                //TODO: Log missing value so we capture in logs
                return nil
            }
        }
    }
    ...
    func value(for manufacturer: Manufacturer) -> PTPDevicePropertyDataType {
        ...
        case .canon:
            ...
            case (30, 1): return Word(0x10)
            case (25, 1): return Word(0x13)
            case (20, 1): return Word(0x15)
            case (15, 1): return Word(0x18)
            case (13, 1): return Word(0x1b)
            case (10, 1): return Word(0x1d)
            case (8, 1): return Word(0x20)
            case (6, 1): return Word(0x23)
            case (5, 1): return Word(0x25)
            case (4, 1): return Word(0x28)
            case (3.2, 1): return Word(0x2b)
            case (2.5, 1): return Word(0x2d)
            case (2, 1): return Word(0x30)
            case (1.6, 1): return Word(0x32)
            case (1.3, 1): return Word(0x35)
            case (1, 1): return Word(0x38)
            case (0.8, 1): return Word(0x3b)
            case (0.6, 1): return Word(0x3d)
            case (0.5, 1): return Word(0x40)
            case (0.4, 1): return Word(0x43)
            case (0.3, 1): return Word(0x45)
            case (1, 4): return Word(0x48)
            case (1, 5): return Word(0x4b)
            case (1, 6): return Word(0x4d)
            case (1, 8): return Word(0x50)
            case (1, 10): return Word(0x53)
            case (1, 13): return Word(0x55)
            case (1, 15): return Word(0x58)
            case (1, 20): return Word(0x5b)
            case (1, 25): return Word(0x5d)
            case (1, 30): return Word(0x60)
            case (1, 40): return Word(0x63)
            case (1, 50): return Word(0x65)
            case (1, 60): return Word(0x68)
            case (1, 80): return Word(0x6b)
            case (1, 100): return Word(0x6d)
            case (1, 125): return Word(0x70)
            case (1, 160): return Word(0x73)
            case (1, 200): return Word(0x75)
            case (1, 250): return Word(0x78)
            case (1, 320): return Word(0x7b)
            case (1, 400): return Word(0x7d)
            case (1, 500): return Word(0x80)
            case (1, 640): return Word(0x83)
            case (1, 800): return Word(0x85)
            case (1, 1000): return Word(0x88)
            case (1, 1250): return Word(0x8b)
            case (1, 1600): return Word(0x8d)
            case (1, 2000): return Word(0x90)
            case (1, 2500): return Word(0x93)
            case (1, 3200): return Word(0x95)
            case (1, 4000): return Word(0x98)
            case (1, 5000): return Word(0x9a)
            case (1, 6400): return Word(0x9d)
            case (1, 8000): return Word(0xa0)
            default:
