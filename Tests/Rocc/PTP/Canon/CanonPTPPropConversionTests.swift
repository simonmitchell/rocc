...
class CanonPTPPropConversionTests: XCTestCase {
    ...
    func testShutterSpeedConvertsToDataCorrectly() throws {
        ...
        let testCases: [(DWord, ShutterSpeed)] = [
            (DWord(0x04), .bulb),
            (DWord(0x10), .init(numerator: 30, denominator: 1)),
            (DWord(0x13), .init(numerator: 25, denominator: 1)),
            (DWord(0x15), .init(numerator: 20, denominator: 1)),
            (DWord(0x18), .init(numerator: 15, denominator: 1)),
            (DWord(0x1b), .init(numerator: 13, denominator: 1)),
            (DWord(0x1d), .init(numerator: 10, denominator: 1)),
            (DWord(0x20), .init(numerator: 8, denominator: 1)),
            (DWord(0x23), .init(numerator: 6, denominator: 1)),
            (DWord(0x25), .init(numerator: 5, denominator: 1)),
            (DWord(0x28), .init(numerator: 4, denominator: 1)),
            (DWord(0x2b), .init(numerator: 3.2, denominator: 1)),
            (DWord(0x2d), .init(numerator: 2.5, denominator: 1)),
            (DWord(0x30), .init(numerator: 2, denominator: 1)),
            (DWord(0x32), .init(numerator: 1.6, denominator: 1)),
            (DWord(0x35), .init(numerator: 1.3, denominator: 1)),
            (DWord(0x38), .init(numerator: 1, denominator: 1)),
            (DWord(0x3b), .init(numerator: 0.8, denominator: 1)),
            (DWord(0x3d), .init(numerator: 0.6, denominator: 1)),
            (DWord(0x40), .init(numerator: 0.5, denominator: 1)),
            (DWord(0x43), .init(numerator: 0.4, denominator: 1)),
            (DWord(0x45), .init(numerator: 0.3, denominator: 1)),
            (DWord(0x48), .init(numerator: 1, denominator: 4)),
            (DWord(0x4b), .init(numerator: 1, denominator: 5)),
            (DWord(0x4d), .init(numerator: 1, denominator: 6)),
            (DWord(0x50), .init(numerator: 1, denominator: 8)),
            (DWord(0x53), .init(numerator: 1, denominator: 10)),
            (DWord(0x55), .init(numerator: 1, denominator: 13)),
            (DWord(0x58), .init(numerator: 1, denominator: 15)),
            (DWord(0x5b), .init(numerator: 1, denominator: 20)),
            (DWord(0x5d), .init(numerator: 1, denominator: 25)),
            (DWord(0x60), .init(numerator: 1, denominator: 30)),
            (DWord(0x63), .init(numerator: 1, denominator: 40)),
            (DWord(0x65), .init(numerator: 1, denominator: 50)),
            (DWord(0x68), .init(numerator: 1, denominator: 60)),
            (DWord(0x6b), .init(numerator: 1, denominator: 80)),
            (DWord(0x6d), .init(numerator: 1, denominator: 100)),
            (DWord(0x70), .init(numerator: 1, denominator: 125)),
            (DWord(0x73), .init(numerator: 1, denominator: 160)),
            (DWord(0x75), .init(numerator: 1, denominator: 200)),
            (DWord(0x78), .init(numerator: 1, denominator: 250)),
            (DWord(0x7b), .init(numerator: 1, denominator: 320)),
            (DWord(0x7d), .init(numerator: 1, denominator: 400)),
            (DWord(0x80), .init(numerator: 1, denominator: 500)),
            (DWord(0x83), .init(numerator: 1, denominator: 640)),
            (DWord(0x85), .init(numerator: 1, denominator: 800)),
            (DWord(0x88), .init(numerator: 1, denominator: 1000)),
            (DWord(0x8b), .init(numerator: 1, denominator: 1250)),
            (DWord(0x8d), .init(numerator: 1, denominator: 1600)),
            (DWord(0x90), .init(numerator: 1, denominator: 2000)),
            (DWord(0x93), .init(numerator: 1, denominator: 2500)),
            (DWord(0x95), .init(numerator: 1, denominator: 3200)),
            (DWord(0x98), .init(numerator: 1, denominator: 4000)),
            (DWord(0x9a), .init(numerator: 1, denominator: 5000)),
            (DWord(0x9d), .init(numerator: 1, denominator: 6400)),
            (DWord(0xa0), .init(numerator: 1, denominator: 8000)),
        ]

        XCTAssertEqual(ShutterSpeed.dataType(for: .canon), .uint32)
        XCTAssertEqual(ShutterSpeed.devicePropertyCode(for: .canon), .shutterSpeedCanonEOS)

        testCases.forEach { (testCase) in
            XCTAssertEqual(
                testCase.0,
                testCase.1.value(for: .canon) as? DWord
            )
        }
    }
}
